...
<title>Future Maker || Pagina Inicial</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>- Future Maker -</h3>      
           <p>ALUNOS CADASTRADOS PODEM FAZER LOGIN AQUI!!!</p>             
          <div class="readmore">
          <a href="user/login.php">Login Estudante<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
