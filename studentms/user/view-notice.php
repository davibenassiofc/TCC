...
<html lang="en">
  <head>
    ...
    <title>Future Maker|| Ver Avisos</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Ver avisos </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Ver Avisos</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
<td colspan="4" style="font-size:20px;color:blue">
 Aviso</td></tr>
<tr class="table-info">
    <th>Data de anúncio do Aviso</th>
  ...
  <?php $cnt=$cnt+1;}} else { ?>
<tr>
  <th colspan="2" style="color:red;">Nenhum aviso encontrado</th>
</tr>
  <?php } ?>
</table>
                  </div>
