...
<html lang="en">
  <head>
    ...
    <title>Sistema de Gestão de Alunos|||Entre Datas Relatórios</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">Entre Datas Relatórios </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="Dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Entre Datas Relatórios</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
?>
<h5 align="center" style="color:blue">Reportado de <?php echo $fdate?> à <?php echo $tdate?></h5>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Código do Estudante</th>
                            <th class="font-weight-bold">Classe do Estudante</th>
                            <th class="font-weight-bold">Nome do Estudante</th>
                            <th class="font-weight-bold">Email do Estudante</th>
                            <th class="font-weight-bold">Data de Admissão</th>
...
{               ?>   
                    ...
                    <div align="left">
    <ul class="pagination" >
        <li><a href="?pageno=1"><strong>Primeiro></strong></a></li>
