...
<html lang="en">
  <head>
    ...
    <title>Future Maker || Pagina de Login do Estudante</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-center p-5">
                <div class="brand-logo">
                  <img class="img-md rounded-circle" src="../logo.png" > 
                </div>
                  ...
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                      <label class="form-check-label text-muted">
                        <input type="checkbox" id="remember" class="form-check-input" name="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?> /> Lembrar de mim </label>
                    </div>
                    <a href="forgot-password.php" class="auth-link text-black">Esqueci Minha Senha</a>
                  </div>
                  <div class="mb-2">
                    <a href="../index.php" class="btn btn-block btn-facebook auth-form-btn">
                      <i class="icon-social-home mr-2"></i>Voltar a Home </a>
                  </div>
