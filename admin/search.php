...
<html lang="en">
  <head>
    ...
    <title>Future Maker ||| Procurar Estudantes</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Procurar Estudantes </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Procurar Estudantes</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Resutado do "<?php echo $sdata;?>" keyword </h4>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold"> Data de Registro</th>
