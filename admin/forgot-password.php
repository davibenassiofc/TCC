...
<html lang="en">
  <head>
    ...
    <title>Future Maker || Trocar Senha</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-center p-5">
                ...
                <h6 class="font-weight-light">Entre no seu E-mail ou Telefone para recuperar a Senha</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-success btn-block loginbtn" name="submit" type="submit">Restaurar</button>
                  </div>
                  <div class="my-2 d-flex justify-content-between align-items-center">
                    
                    <a href="login.php" class="auth-link text-black">ㅤ</a>
                  </div>
                  <div class="mb-2">
