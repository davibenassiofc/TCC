...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Perfil</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Perfil de Admin </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Perfil de Admin</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Perfil de Admin</h4>
...
{               ?>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Nome de Usuário</label>
                        <input type="text" name="username" value="<?php  echo $row->UserName;?>" class="form-control" readonly="">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Numer de Contato</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputCity1">Data de Registro do Admin</label>
