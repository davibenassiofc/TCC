...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Atualização Contato</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Atualização Contato</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Atualização Contato</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Atualização Contato</h4>
...
{               ?>    
                      <div class="form-group">
                        <label for="exampleInputName1">Titulo da Página:</label>
                        <input type="text" name="pagetitle" value="<?php  echo $row->PageTitle;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Descrição da Página:</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Número de Celular:</label>
                      ...
                      <?php $cnt=$cnt+1;}} ?>
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Atualizar</button>
